...
JNIEXPORT void JNICALL Java_com_hardrubic_sdk_recordaudio_record_LameUtil_init(
...
JNIEXPORT jint JNICALL Java_com_hardrubic_sdk_recordaudio_record_LameUtil_encode(
...
JNIEXPORT jint JNICALL Java_com_hardrubic_sdk_recordaudio_record_LameUtil_flush(
...
JNIEXPORT void JNICALL Java_com_hardrubic_sdk_recordaudio_record_LameUtil_close
